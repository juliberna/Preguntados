...
class PreguntaController
{
  ...
  public function dameUna()
  {
    ...
    // Persistir que esta pregunta se entregó en esta partida
    // $this->model->registrarPreguntaEnPartida($id_usuario, $id_partida, $pregunta["id_pregunta"]);
  ...
  public function responder()
  {
    ...
    if ($es_correcta) {
      // Sumar punto, actualizar puntaje usuario, etc.
      // Actualizar
